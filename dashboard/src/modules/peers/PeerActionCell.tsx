...
import { SharePeerModal } from "@/modules/peers/SharePeerModal";
          ...
          <FullTooltip
            content={
              <div className={"flex gap-2 items-center !text-nb-gray-300 text-xs"}>
                ...
                <span>Expiration is disabled for all peers added with an setup-key.</span>
              </div>
            }
          ...
          >
            ...
            >
              <div className={"flex gap-3 items-center w-full"}>
                ...
                {peer.login_expiration_enabled ? "Disable" : "Enable"} Session Expiration
              </div>
            </DropdownMenuItem>
          </FullTooltip>
          {showSSHButton && (
            <DropdownMenuItem
              onClick={() =>
                peer.ssh_enabled ? disableDashboardSSH() : setSSHInstructionsModal(true)
              }
