...
type ManagementServiceClient interface {
	...
	// Returns encrypted GeneratePeerCertificateResponse in EncryptedMessage.Body
	GeneratePeerCertificate(ctx context.Context, in *EncryptedMessage, opts ...grpc.CallOption) (*EncryptedMessage, error)
}
...
func (c *managementServiceClient) GeneratePeerCertificate(ctx context.Context, in *EncryptedMessage, opts ...grpc.CallOption) (*EncryptedMessage, error) {
	out := new(EncryptedMessage)
	err := c.cc.Invoke(ctx, "/management.ManagementService/GeneratePeerCertificate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ManagementServiceServer interface {
	...
	// GeneratePeerCertificate generates an SSL certificate for a domain using Let's Encrypt ACME
	// Returns encrypted GeneratePeerCertificateResponse in EncryptedMessage.Body
	GeneratePeerCertificate(context.Context, *EncryptedMessage) (*EncryptedMessage, error)
...
func (UnimplementedManagementServiceServer) GeneratePeerCertificate(context.Context, *EncryptedMessage) (*EncryptedMessage, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GeneratePeerCertificate not implemented")
}
...
func _ManagementService_GeneratePeerCertificate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EncryptedMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ManagementServiceServer).GeneratePeerCertificate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/management.ManagementService/GeneratePeerCertificate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ManagementServiceServer).GeneratePeerCertificate(ctx, req.(*EncryptedMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ManagementService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GeneratePeerCertificate",
			Handler:    _ManagementService_GeneratePeerCertificate_Handler,
		},
	},
