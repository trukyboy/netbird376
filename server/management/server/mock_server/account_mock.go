...
// Source: management/server/account/manager.go
...
// GetCrossNetworkExposeManager mocks base method.
func (m *MockManager) GetCrossNetworkExposeManager() *account.CrossNetworkExposeManager {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetCrossNetworkExposeManager")
	ret0, _ := ret[0].(*account.CrossNetworkExposeManager)
	return ret0
}

// GetCrossNetworkExposeManager indicates an expected call of GetCrossNetworkExposeManager.
func (mr *MockManagerMockRecorder) GetCrossNetworkExposeManager() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetCrossNetworkExposeManager", reflect.TypeOf((*MockManager)(nil).GetCrossNetworkExposeManager))
}
...
func (m *MockManager) GetExternalCacheManager() account.ExternalCacheManager {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetExternalCacheManager")
	ret0, _ := ret[0].(account.ExternalCacheManager)
	return ret0
}
