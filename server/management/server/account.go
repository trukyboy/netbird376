...
type DefaultAccountManager struct {
	...
	crossNetworkExposeManager *account.CrossNetworkExposeManager
}
...
func BuildManager(
	...
	// Initialize CrossNetworkExposeManager
	am.crossNetworkExposeManager = account.NewCrossNetworkExposeManager(am)
	log.WithContext(ctx).Debugf("CrossNetworkExposeManager initialized")
...
// GetCrossNetworkExposeManager returns the CrossNetworkExposeManager instance
func (am *DefaultAccountManager) GetCrossNetworkExposeManager() *account.CrossNetworkExposeManager {
	return am.crossNetworkExposeManager
}
