...
type Repository interface {
	...
	GetAccountPeers(ctx context.Context, accountID string) ([]*nbpeer.Peer, error)
	GetAccountByPeerID(ctx context.Context, peerID string) (*types.Account, error)
	GetPeersByIDs(ctx context.Context, accountID string, peerIDs []string) (map[string]*nbpeer.Peer, error)
	GetPeerByID(ctx context.Context, accountID string, peerID string) (*nbpeer.Peer, error)
...
func (r *repository) GetAccountPeers(ctx context.Context, accountID string) ([]*nbpeer.Peer, error) {
...
func (r *repository) GetPeersByIDs(ctx context.Context, accountID string, peerIDs []string) (map[string]*nbpeer.Peer, error) {
	return r.store.GetPeersByIDs(ctx, store.LockingStrengthNone, accountID, peerIDs)
}

func (r *repository) GetPeerByID(ctx context.Context, accountID string, peerID string) (*nbpeer.Peer, error) {
...
func (r *repository) GetCrossNetworkPeersConfig(ctx context.Context, peerID string) ([]*proto.CrossNetworkPeerConfig, error) {
	return r.store.GetCrossNetworkPeersConfig(ctx, peerID)
}
